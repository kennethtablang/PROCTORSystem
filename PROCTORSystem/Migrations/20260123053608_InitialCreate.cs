        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TargetStudentId = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RemoteCommands_Students_StudentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RemoteCommands_StudentId",
                table: "RemoteCommands",
                column: "StudentId");

            migrationBuilder.CreateIndex(
                name: "IX_Students_IPAddress",
                table: "Students",
                column: "IPAddress");

            migrationBuilder.CreateIndex(
                name: "IX_Students_MachineName",
                table: "Students",
                column: "MachineName");
        }
